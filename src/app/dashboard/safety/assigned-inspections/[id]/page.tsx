...
import { Loader2, ArrowLeft, Save, User, Calendar, Camera, Trash2, Signature } from "lucide-react";
...
export default function CompleteInspectionPage() {
    ...
    const { safetyInspections, users, loading, completeSafetyInspection } = useAppState();
    ...
    const inspector = useMemo(() => {
        ...
        return users.find(u => u.id === inspectionData.createdBy);
            ...
            reader.onload = (e) => {
                if (typeof e.target?.result === 'string') {
                    setInspectionData(prevData => {
                        ...
                        return {
                            ...prevData,
                            completionPhotos: [...(prevData.completionPhotos || []), e.target.result as string]
                        };
                    });
                }
            };
    ...
    return (
        <div className="flex flex-col gap-8">
            <div className="flex items-center gap-4">
                ...
                <PageHeader title="Resolver Inspección de Seguridad" description={`Tarea asignada para la obra: ${inspectionData.work}`} className="mb-0"/>
            </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm p-3 bg-muted/50 rounded-md mt-1">{inspectionData.actionPlan}</p>
                            </div>
                            <div>
                     ...
                     <Card>
                         ...
                         <CardContent className="space-y-4 text-sm">
                             ...
                             <div className="flex items-center gap-2 text-muted-foreground">
                                ...
                                <span>Fecha del Reporte: <span className="font-semibold text-foreground">{formatDate(inspectionData.createdAt)}</span></span>
                             </div>
                              <div className="flex items-center gap-2 text-muted-foreground">
