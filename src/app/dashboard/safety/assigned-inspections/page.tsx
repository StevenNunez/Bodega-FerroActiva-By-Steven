...
import { ShieldCheck, AlertCircle, Inbox, ArrowRight } from "lucide-react";
                                ...
                                {myAssignedInspections.map(inspection => (
                                    ...
                                    >
                                        <div className="flex-grow">
                                            <p className="font-semibold text-primary">{inspection.work} - {inspection.location}</p>
                                            <p className="text-sm font-medium text-foreground truncate">{inspection.description}</p>
                                            <p className="text-xs text-muted-foreground mt-1">Asignado por: {userMap.get(inspection.createdBy) || 'Desconocido'}</p>
                                            <p className="text-xs text-muted-foreground">Fecha: {formatDate(inspection.assignedAt)}</p>
                                        </div>
