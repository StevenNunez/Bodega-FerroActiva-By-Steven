...
import { Loader2, ArrowLeft, Download, User, Calendar, Signature } from "lucide-react";
...
export default function BehaviorObservationDetailPage() {
    ...
    const { behaviorObservations, loading } = useAppState();
        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-1 space-y-8 sticky top-8">
                  <Card>
                       <CardHeader>
                            <CardTitle className="flex items-center gap-2"><Signature /> Firma del Observador</CardTitle>
                        </CardHeader>
                        <CardContent>
                  ...
                  <Card>
                       <CardHeader>
                            <CardTitle className="flex items-center gap-2"><Signature /> Firma del Trabajador</CardTitle>
                        </CardHeader>
                        <CardContent>
                           <div className="p-2 border rounded-md bg-white">
