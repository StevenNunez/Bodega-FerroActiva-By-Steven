...
import type { AssignedChecklist, User } from "@/lib/data";
...
export default function AprReviewPage() {
    ...
    const aprUser = useMemo(() => {
        if (!checklist) return null;
        return users.find(u => u.id === checklist.assignedBy);
    }, [checklist, users]);
        ...
        <div className="flex flex-col gap-8">
            <div className="flex items-center justify-between gap-4 flex-wrap">
                 <div className="flex items-center gap-4">
                    ...
                    <PageHeader title={checklist.templateTitle} description={`Revisando para la obra: ${checklist.work}`} className="mb-0"/>
                 </div>
                 <div className="flex items-center gap-4">
                    {isReviewed && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-1 space-y-8 sticky top-8">
                  <Card>
                       <CardHeader>
                            <CardTitle className="flex items-center gap-2"><Signature /> Firma del Supervisor</CardTitle>
                        </CardHeader>
                        <CardContent>
