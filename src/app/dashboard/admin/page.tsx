...
import { Bell, Wrench, Users, Package, AlertTriangle, PackageSearch, TrendingUp, DollarSign, ShoppingCart, ClipboardList } from "lucide-react";
...
import type { MaterialRequest, SupplierPayment } from "@/lib/data";
...
export default function AdminPage() {
  ...
  const lowStockCriticalMaterials = React.useMemo(() => {
    ...
    return materials
      ...
      .sort((a, b) => (materialUsage[b.id] || 0) - (materialUsage[a.id] || 0));
  }, [materials, requests]);
