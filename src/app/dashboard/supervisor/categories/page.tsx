    ...
    return (
        <div className="flex flex-col gap-8">
            <PageHeader
                ...
                description="Crea y edita las categorías de materiales para mantener el sistema organizado."
            />
                ...
                <div className="lg:col-span-1">
                     <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Añade una nueva categoría para organizar los materiales.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <CreateCategoryForm />
                        </CardContent>
