...
// 🧩 Overlay corregido: ahora no bloquea clics tras cerrar
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      onEscapeKeyDown={(e) => e.stopPropagation()} // evita bloqueos al presionar ESC
      onPointerDownOutside={(e) => e.preventDefault()} // evita que se "pierda" el foco
      className={cn(
